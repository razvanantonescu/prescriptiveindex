...
$chestionar = array (
						'name' => '{"ro":"Roata Profilului afectiv binar","en":"Binary Affective Profile Wheel"}',
						'desc' => '{"ro":"In roata de mai jos veti gasi un numar de cuvinte si expresii care descriu diferite emotii si trairi. Cititi fiecare item si apoi marcati răspunsul adecvat.","en":"In roata de mai jos veti gasi un numar de cuvinte si expresii care descriu diferite emotii si trairi. Cititi fiecare item si apoi marcati răspunsul adecvat."}',
						'max_score' => 0,
						'display_type' => 'radial',
						'quest_type' => 'normal'
);
